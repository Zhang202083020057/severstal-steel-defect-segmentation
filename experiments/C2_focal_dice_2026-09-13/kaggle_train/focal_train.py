"""Train the controlled C2-targeted-augmentation plus Focal-Dice experiment."""
...
def main() -> None:
    ...
    run(
        ...
        "--output", "/kaggle/working/submission_0_5.csv",
    ...
    print("C2_FOCAL_DICE_TRAINING_COMPLETE", flush=True)
