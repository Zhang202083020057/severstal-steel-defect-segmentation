"""Offline Code Submission using V2 weights and validation-calibrated post-processing."""
...
def main() -> None:
    ...
    if len(test_dirs) != 1:
        raise RuntimeError(f"Expected one competition test directory, found: {test_dirs}")
