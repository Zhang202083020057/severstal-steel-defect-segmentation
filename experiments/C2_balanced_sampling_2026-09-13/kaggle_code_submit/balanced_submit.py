"""Offline Code Submission for the C2 balanced-sampling experiment."""
...
def main() -> None:
    ...
    if len(checkpoints) != 1:
        raise RuntimeError(f"Expected one balanced checkpoint, found: {checkpoints}")
    ...
    subprocess.check_call(
        [
            ...
            "--data-dir", str(test_dirs[0].parent),
            "--checkpoint", str(work_dir / "best_model.pt"),
            "--output", str(output),
